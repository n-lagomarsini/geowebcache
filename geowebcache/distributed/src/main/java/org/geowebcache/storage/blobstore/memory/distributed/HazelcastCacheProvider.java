 ...
 * indicates the number of hits considering also the requests made by other cluster instances while the total operation count indicates only the
 * number of GET operations requested on the local cluster instance.
 * 
